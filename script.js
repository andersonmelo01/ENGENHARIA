...
function abrirBot() {
    ...
    // Solicita permissão de notificação APENAS após ação do usuário
...
function mensagemInicial() {
    ...
    setTimeout(() => botMsg(
        "1️⃣ Projetos Estruturais\n" +
        "2️⃣ Drenagem Urbana\n" +
        "3️⃣ Pavimentação\n" +
        "4️⃣ Abastecimento de Água\n" +
        "5️⃣ Rede de Esgoto\n" +
        "6️⃣ Topografia\n" +
        "7️⃣ Laudos e Vistorias\n" +
        "8️⃣ Execução / Gerenciamento\n" +
        "9️⃣ Consultoria Técnica"
    ), 2000);
